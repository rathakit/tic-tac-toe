...
import com.threet.game.model.Gamer;
import com.threet.game.model.Owner;
import com.threet.game.model.Player;
import com.threet.game.model.Robot;
import com.threet.game.model.Status;
...
/**
 * The BoardActivity is the game board.
 * @author tchin
 *
 */
public class BoardActivity extends BaseActivity implements OnItemClickListener {
	...
	/**
	 * This method will be invoked when clicking on the retry button.
	 * @param v
	 */
	...
	protected void initActivity() {
		...
		// Players
		firstGamer = new Gamer(Owner.P1, board, "Peter");
		...
		if (numberOfPlayers == onePlayer) {
			...
			secondGamer = new Gamer(Owner.P2, board, "Stephen");
		}
